#!/bin/bash
echo "compile amlogic for wangMingde......"
git pull
./scripts/feeds update -a && ./scripts/feeds install -a
rm -rf ./files/*
cp -rf ../openwrt-action/amlogicfiles/* ./files
cp -rf ../openwrt-action/amlogic.config .config
cp -rf ../openwrt-action/zzz-default-settings-amlogic ./package/lean/default-settings/files/zzz-default-settings
